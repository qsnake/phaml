c This is subroutine dmnfb and its dependencies in the PORT package, obtained
c from NETLIB 3/6/2012.  D1MACH is not included because I already have it in
c dbinom.f.  I1MACH is replaced with a Fortran 90 version.

c dmnfb finds a local minimum of a continuously differentiable function
c subject to simple upper and lower bound constraints.  I added it to PHAML
c for finding out if a point in 3D is on a surface patch of the domain
c defined by transfinite interpolation of 3 or 4 edges.
