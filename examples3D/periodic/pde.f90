...
cyy(1,1) = 1.0_my_real
czz(1,1) = 1.0_my_real
rs = (z**2*8*pi**2-2)*sin(2*pi*x+1)*sin(2*pi*y+1)
...
!case (13,17)                   ! use this for periodic in x
!case (11,15)                   ! use this for periodic in y
case (13,17,11,15,10,12,14,16) ! use this for periodic in both x and y
...
trues = z**2*sin(2*pi*x+1)*sin(2*pi*y+1)
...
truexs = z**2*2*pi*cos(2*pi*x+1)*sin(2*pi*y+1)
...
trueys = z**2*2*pi*sin(2*pi*x+1)*cos(2*pi*y+1)
...
truezs = 2*z*sin(2*pi*x+1)*sin(2*pi*y+1)
