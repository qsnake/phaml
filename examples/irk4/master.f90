...
!
! This version solves a parabolic equation using a 4th order implicit
! Runge Kutta method.  See README.irk4 for a description of the scheme.
!
!----------------------------------------------------
...
t = 0.0_my_real
call phaml_create(soln,nproc,update_umod=.true.,system_size=6, &
