...
cxx(2,1) = 0.0_my_real;        cxx(2,2) = 0.0_my_real

cyy(1,1) = 1.0_my_real;        cyy(1,2) = 0.0_my_real
cyy(2,1) = 0.0_my_real;        cyy(2,2) = 0.0_my_real

c(1,1) = 0.0_my_real;          c(1,2) = 1.0_my_real/(deltat*kappa**2)
c(2,1) = -1.0_my_real/deltat;  c(2,2) = 1.0_my_real

call phaml_evaluate_old(x,y,u_old,comp=1)
call phaml_evaluate_old(x,y,v_old,comp=2)

rs(1) = v_old/(deltat*kappa**2)
rs(2) = -u_old/deltat
...
case (2)
   iconds = kappa*pi*sqrt2*cos(kappa*pi*sqrt2*t)*sin(pi*x)*sin(pi*y)

case default
   print *,"bad value for comp in iconds"
...
select case (comp)
case (1)
   trues =  sin(kappa*sqrt2*pi*t)*sin(pi*x)*sin(pi*y)
case (2)
   trues =  kappa*sqrt2*pi*cos(kappa*sqrt2*pi*t)*sin(pi*x)*sin(pi*y)
case default
   print *,"bad value for comp in trues"
end select
...
select case (comp)
case (1)
   truexs =  pi*sin(kappa*sqrt2*pi*t)*cos(pi*x)*sin(pi*y)
case (2)
   truexs =  kappa*sqrt2*pi*pi*cos(kappa*sqrt2*pi*t)*cos(pi*x)*sin(pi*y)
case default
   print *,"bad value for comp in truexs"
end select
...
select case (comp)
case (1)
   trueys =  pi*sin(kappa*sqrt2*pi*t)*sin(pi*x)*cos(pi*y)
case (2)
   trueys =  kappa*sqrt2*pi*pi*cos(kappa*sqrt2*pi*t)*sin(pi*x)*cos(pi*y)
case default
   print *,"bad value for comp in trueys"
end select
