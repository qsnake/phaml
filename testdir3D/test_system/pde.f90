...
czz(1,1) = 1.0_my_real;  czz(1,2) = 0.0_my_real
czz(2,1) = 0.0_my_real;  czz(2,2) = 1.0_my_real
...
!----------------------------------------------------
! This is the z derivative of the comp'th true solution of the differential
! equation, if known.
!----------------------------------------------------
...
select case (comp)
   ...
   case default
      print *,"ERROR -- bad value ",comp," for comp in truezs"
      stop
