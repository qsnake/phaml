...
cyy(1,1) = 1.0_my_real
czz(1,1) = 1.0_my_real
rs(1) = -z**6*(12*x**2-12*x+2+12*y**2-12*y+2) - 30*z**4*(x**2*(1-x)**2+y**2*(1-y)**2)
...
truezs = 6*z**5*(x**2*(x-1)**2 + y**2*(y-1)**2)
