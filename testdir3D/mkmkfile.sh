...
echo "	@ ./run_tests.sh $PHAML_ARCH $PHAML_OS $PHAML_F90 $PHAML_C $PHAML_HASHSIZE $PHAML_PARALLEL $PHAML_PARLIB $PHAML_ELEMENT $PHAML_GRAPHICS $PHAML_BLAS $PHAML_LAPACK $PHAML_SLEPC $PHAML_ARPACK $PHAML_BLOPEX $PHAML_HYPRE $PHAML_MUMPS $PHAML_PETSC $PHAML_SUPERLU $PHAML_SYSTEM $PHAML_ZOLTAN $PHAML_PARMETIS $PHAML_JOSTLE $PHAML_PATOH $PHAML_PARKWAY $PHAML_NEMESIS $PHAML_DRUM $RUNMPI"' $(what)' 1>>Makefile
